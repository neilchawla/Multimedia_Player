 ...
 * Original file: /Users/neilchawla/Desktop/Project 5/service/app/src/main/aidl/course/examples/Services/KeyCommon/KeyGenerator.aidl
 */
...
int _arg0;
_arg0 = data.readInt();
android.graphics.Bitmap _result = this.sendImage(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
...
@Override public void playAudio(int number) throws android.os.RemoteException
{
...
@Override public android.graphics.Bitmap sendImage(int number) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
static final int TRANSACTION_playAudio = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_pauseAudio = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
...
public void playAudio(int number) throws android.os.RemoteException;
public void pauseAudio() throws android.os.RemoteException;
public void stopAudio() throws android.os.RemoteException;
public android.graphics.Bitmap sendImage(int number) throws android.os.RemoteException;
}
